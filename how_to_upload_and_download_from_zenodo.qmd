...
subtitle: Part 6 - How to Upload to and Download from Zenodo
date: today
author:
  - name: 
        family: Krug
...
citation:
  type: report
  container-title: " IPBES Technical Guidelines: Part 6 - How to Upload to and Download from Zenodo"
  doi: 10.5281/zenodo.6834336
doi: 10.5281/zenodo.6834336
version: 1.1
...
htmltools::img(src = knitr::image_uri("C:/Users/jkumagai/Documents/IPBES/R/Geoinformatics/Technical Guidelines Series/Zenodo/figures/logo2.png"), 
               alt = 'logo', 
...
![*Figure 1: Reserving a DOI on Zenodo*](figures/Figure1.png)
...
![*Figure 2: Options of some available roles for names listed under the Contributors section.*](figures/Figure3.png)
...
![*Figure 3: Example of related identifiers specified on the overarching IPBES Data Management Tutorials Zenodo upload (<https://doi.org/10.5281/zenodo.4020373>)*](figures/Figure4_related_identifier.png){width="375"}

### E. Access and licenses

Uploads related to IPBES assessments should be set to open access at the latest one calendar month following the adoption of the assessment by Plenary, unless a longer embargo period is approved by the task force on knowledge and data. Please see the [IPBES data and knowledge management policy](10.5281/zenodo.3551078) for more information.
...
![*Figure 4: The Zenodo interface when your GitHub account is linked. The bottom of the image shows a repository and corresponding toggle switch*](figures/Figure6_GithubLink.png)  
...
![*Figure 5: Screen shot capturing the area of the Zenodo upload which specifies the DOI to use to cite all versions of the IPBES data management policy*](figures/Figure5_cite_all_versions.png){width="375"}
...
![*Figure 6: Example of available files and the download option from the IPBES Data Management Tutorials Zenodo record (<https://doi.org/10.5281/zenodo.4020373>)*](figures/Figure2.png)
...
Within Python, there's a package available on GitHub [here](https://github.com/dvolgyes/zenodo_get) which allows one to download from Zenodo using the function `zenodo_get`. 
  
Within R, there's a handy function called [`download_zenodo`](https://rdrr.io/github/inbo/inborutils/man/download_zenodo.html) from the package [`inborutils`](https://inbo.github.io/inborutils/) that allows one to download from Zenodo easily.
...
```{r}
#| label: download_zenodo_ipbes_regions
#| message: false
#| warning: false
